...
#
# Copyright 2001, 2002, 2003, 2004, 2005 Aurelio Marinho Jargas
#
...
def getUnknownErrorMessage():
	msg = '%s\n%s (%s):\n\n%s'%(
	  _('Sorry! Txt2tags aborted by an unknow error.'),
...
class BlockMaster:
	...
	def blockout(self):
		...
		if tagged: Debug('BLOCK: %s'%tagged, 6)
		return tagged
